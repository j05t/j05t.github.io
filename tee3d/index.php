...
<nav>
    <div id="menuToggle">
        ...
        <ul id="menu">
            ...
            <li><a id="3d" href="#">3D-Ansicht</a></li>

            <li><a id="headTransparent" href="#">Head transparent</a></li>
            ...
            <li>
                <a id="engravedBy" href="https://www.edelraster.at/" target="_blank">Engraved by<img src="img/edelraster_logo.png" alt="edelraster.at" /></a>
            </li>
...
<script>
    ...
    document.getElementById('3d').addEventListener('click', function () {
        moveAndLookAt(threeDView, lookAt, 500);
    });
    ...
    // disable controller when menu is open
    document.getElementById('hidden_checkbox').addEventListener('click', function () {
